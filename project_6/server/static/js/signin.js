$(function () {
    ...
    $("#signin-submit").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "http://127.0.0.1:5000/signin.do",
            dataType: "json",
            data: signin_form,
            success: function (data) {
                if (data == "success") {
                    location.href = "http://127.0.0.1:5000/monitor";
                }
                else {
    ...
    $("#signup-submit").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "http://127.0.0.1:5000/signup.do",
            dataType: "json",
            data: signup_form,
            success: function (data) {
                if (data == "success") {
                    ...
                    setTimeout(function () { location.href = "http://127.0.0.1:5000/monitor"; }, 2000);
                    return;
                }
